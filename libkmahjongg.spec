...
Version  : 23.08.4
Release  : 61
URL      : https://download.kde.org/stable/release-service/23.08.4/src/libkmahjongg-23.08.4.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/libkmahjongg-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/libkmahjongg-23.08.4.tar.xz.sig
...
%prep
%setup -q -n libkmahjongg-23.08.4
cd %{_builddir}/libkmahjongg-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702930254
mkdir -p clr-build
pushd clr-build
