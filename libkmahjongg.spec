...
%setup -q -n libkmahjongg-24.05.0
cd %{_builddir}/libkmahjongg-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716480192
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKMahjongg6.so.6.0.240500
/usr/lib64/libKMahjongg6.so.6
/usr/lib64/libKMahjongg6.so.6.0.240500
