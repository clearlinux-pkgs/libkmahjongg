...
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/libkmahjongg-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/libkmahjongg-25.04.2.tar.xz.sig
...
%setup -q -n libkmahjongg-25.04.2
cd %{_builddir}/libkmahjongg-25.04.2
pushd ..
cp -a libkmahjongg-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749486470
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKMahjongg6.so.6.0.250402
/usr/lib64/libKMahjongg6.so.6
/usr/lib64/libKMahjongg6.so.6.0.250402
