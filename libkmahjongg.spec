...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/libkmahjongg-21.12.0.tar.xz
...
%prep
%setup -q -n libkmahjongg-21.12.0
cd %{_builddir}/libkmahjongg-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639610238
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkmahjongg-21.12.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/libkmahjongg/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/libkmahjongg-21.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkmahjongg/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
