...
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/libkmahjongg-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/libkmahjongg-24.02.2.tar.xz.sig
...
%prep
%setup -q -n libkmahjongg-24.02.2
cd %{_builddir}/libkmahjongg-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712860779
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKMahjongg6.so.6.0.240202
/usr/lib64/libKMahjongg6.so.6
/usr/lib64/libKMahjongg6.so.6.0.240202
