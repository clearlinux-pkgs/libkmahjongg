...
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/libkmahjongg-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/libkmahjongg-25.04.0.tar.xz.sig
...
%setup -q -n libkmahjongg-25.04.0
cd %{_builddir}/libkmahjongg-25.04.0
pushd ..
cp -a libkmahjongg-25.04.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744907305
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKMahjongg6.so.6.0.250400
/usr/lib64/libKMahjongg6.so.6
/usr/lib64/libKMahjongg6.so.6.0.250400
