...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/libkmahjongg-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/libkmahjongg-24.12.3.tar.xz.sig
...
%setup -q -n libkmahjongg-24.12.3
cd %{_builddir}/libkmahjongg-24.12.3
pushd ..
cp -a libkmahjongg-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742426902
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKMahjongg6.so.6.0.241203
/usr/lib64/libKMahjongg6.so.6
/usr/lib64/libKMahjongg6.so.6.0.241203
