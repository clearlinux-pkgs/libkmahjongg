...
Version  : 24.12.0
Release  : 75
URL      : https://download.kde.org/stable/release-service/24.12.0/src/libkmahjongg-24.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/libkmahjongg-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/libkmahjongg-24.12.0.tar.xz.sig
...
%setup -q -n libkmahjongg-24.12.0
cd %{_builddir}/libkmahjongg-24.12.0
pushd ..
cp -a libkmahjongg-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735172133
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKMahjongg6.so.6.0.241200
/usr/lib64/libKMahjongg6.so.6
/usr/lib64/libKMahjongg6.so.6.0.241200
