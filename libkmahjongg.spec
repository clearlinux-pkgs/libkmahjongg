...
Version  : 24.02.0
Release  : 63
URL      : https://download.kde.org/stable/release-service/24.02.0/src/libkmahjongg-24.02.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/libkmahjongg-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/libkmahjongg-24.02.0.tar.xz.sig
...
%prep
%setup -q -n libkmahjongg-24.02.0
cd %{_builddir}/libkmahjongg-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709242932
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKMahjongg6.so.6.0.240200
/usr/lib64/libKMahjongg6.so.6
/usr/lib64/libKMahjongg6.so.6.0.240200
