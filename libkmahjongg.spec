...
Version  : 24.08.1
Release  : 73
URL      : https://download.kde.org/stable/release-service/24.08.1/src/libkmahjongg-24.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/libkmahjongg-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/libkmahjongg-24.08.1.tar.xz.sig
...
%setup -q -n libkmahjongg-24.08.1
cd %{_builddir}/libkmahjongg-24.08.1
pushd ..
cp -a libkmahjongg-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726158231
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKMahjongg6.so.6.0.240801
/usr/lib64/libKMahjongg6.so.6
/usr/lib64/libKMahjongg6.so.6.0.240801
